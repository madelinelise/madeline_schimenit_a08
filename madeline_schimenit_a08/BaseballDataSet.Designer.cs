...
namespace madeline_schimenit_a08.BaseballDataSetTableAdapters {
...
SELECT PlayerID, FirstName, LastName, BattingAverage FROM Players WHERE (PlayerID = @PlayerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::madeline_schimenit_a08.Properties.Settings.Default.BaseballConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        PlayerID, FirstName, LastName, BattingAverage, BattingAverage AS Ex" +
                "pr1\r\nFROM            Players\r\nWHERE        (BattingAverage >= @min) AND (Batting" +
                "Average <= @max)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@min", global::System.Data.SqlDbType.Decimal, 5, global::System.Data.ParameterDirection.Input, 3, 3, "BattingAverage", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@max", global::System.Data.SqlDbType.Decimal, 5, global::System.Data.ParameterDirection.Input, 3, 3, "BattingAverage", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT        PlayerID, FirstName, LastName, BattingAverage\r\nFROM            Play" +
        ...
        public virtual int FillByAvg(BaseballDataSet.PlayersDataTable dataTable, decimal min, decimal max) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(min));
            this.Adapter.SelectCommand.Parameters[1].Value = ((decimal)(max));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
            int returnValue = this.Adapter.Fill(dataTable);
        ...
        public virtual BaseballDataSet.PlayersDataTable GetDataByAvg(decimal min, decimal max) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(min));
            this.Adapter.SelectCommand.Parameters[1].Value = ((decimal)(max));
            BaseballDataSet.PlayersDataTable dataTable = new BaseballDataSet.PlayersDataTable();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual BaseballDataSet.PlayersDataTable GetDataByLastName(string lastName) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((lastName == null)) {
                throw new global::System.ArgumentNullException("lastName");
            }
